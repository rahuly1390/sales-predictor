...
var product = require('../models/productCollection.js');


exports.getProducts = function (req, res) {
  product.find({}).sort({addedOn: 'desc'}).exec(function(err, docs) {
    if (err)
...
exports.insertProduct = function (req, res) {
    ...
    console.log("inside prod"+JSON.stringify(productObj));
    var Data = new product({
      productName: productObj.data.productName,
      productPrice: productObj.data.productPrice,
      productDescription: productObj.data.productDescription,
    });
...
exports.removeProduct = function (req, res) {
  ...
  product.remove({_id: objID}, function(err) {
       if (!err) {
              res.json({
