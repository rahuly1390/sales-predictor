...
//
// //-------------------Todo Scope-------------------------------------------------------
//             $scope.refreshTodo(); //count-my-todos-by-status and get-my-todos
//
//
//
//
...
//   // check for due to-dos, status of isDone is false
...
//   // $scope.numPerPage = 5;
//   //
//   // $scope.paginateTodos = function(value) {
//   //   // console.log("Page");
//   //   var begin, end, index;
...
//   // };
//   //
//   // $scope.$watch('todoSearch', function () {
//   //     if (!$scope.todoSearch)
//   //     {
//   //         $scope.numPerPage = 5;
//   //     }
...
//       };
//
// // $scope.currentEditingTodoId;
//       $scope.editTodo = function (index,id) {
//         $scope.showAddTodo = false;
//         $scope.showSaveTodo = true;
//         $scope.newTodo = '';
//         $scope.newTodo = $scope.todos[index].taskName;
//         $scope.editedTodoID = id;
//       };
//
//
// $scope.saveTodo = function (id) {
//   $scope.showAddTodo = true;
//   $scope.showSaveTodo = false;
//
//   if($scope.newTodo){
//
...
//       $scope.refreshTodo();
//   }).error(function (data) {
//       console.log("Error in /admin/api/edit-todo: " + data);
//   });
// }else {
//   $scope.newTodo = "";//Reset the text field.
// }
...
//
//
// $scope.checkAddEvent = function(event,editedId){
//
//   if($scope.newTodo)
//   {
//     if($scope.showSaveTodo)
//     {
//       if (event.which === 13)
//       {
//         $scope.saveTodo(editedId);
//       }
//     }
//     else{
//       if (event.which === 13)
