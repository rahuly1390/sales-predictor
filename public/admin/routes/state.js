...
.state('storecat', {
    url: "/store-categories.html",
    templateUrl: "views/stores/store-categories.html",
    data: {
        pageTitle: 'Store',
...
// .state('storeview', {
//     url: "/view-stores.html",
//     templateUrl: "views/stores/view-stores.html",
//     data: {
//         pageTitle: 'Store',
//         pageSubTitle: 'View'
//     },
...
.state('productview', {
    url: "/view-products.html",
    templateUrl: "views/products/view-products.html",
    data: {
        pageTitle: 'Product',
        pageSubTitle: 'View'
    },
...
//---------------------------------------------------------------------------------------------------
//logger State 29/6/2015 updated on 13/10/2015
...
.state('adminlogs', {
    ...
    .state('clientlogs', {
            url: "/client-logs.html",
            templateUrl: "views/admin/client-logs.html",
            data: {
